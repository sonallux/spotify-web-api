...
public interface PlayerApi {
     ...
     */
    @POST("/me/player/queue")
    Call<Void> addToQueue(@Query("uri") String uri, @Query("device_id") String deviceId);
     ...
     */
    @GET("/me/player/currently-playing")
    Call<CurrentlyPlaying> getUsersCurrentlyPlayingTrack(@Query("market") String market, @Query("additional_types") String additionalTypes);
     ...
     */
    @PUT("/me/player/pause")
    Call<Void> pauseUsersPlayback(@Query("device_id") String deviceId);
     ...
     */
    @PUT("/me/player/repeat")
    Call<Void> setRepeatModeOnUsersPlayback(@Query("state") String state, @Query("device_id") String deviceId);
     ...
     */
    @POST("/me/player/next")
    Call<Void> skipUsersPlaybackToNextTrack(@Query("device_id") String deviceId);
     ...
     */
    @POST("/me/player/previous")
    Call<Void> skipUsersPlaybackToPreviousTrack(@Query("device_id") String deviceId);
     ...
     */
    @PUT("/me/player/play")
    Call<Void> startUsersPlayback(@Query("device_id") String deviceId, @Body StartUsersPlaybackRequest requestBody);
